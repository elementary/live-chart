private void register_config () {
    Test.add_func ("/Config#boundaries", () => {
        //given
    ...
    Test.add_func ("/Config#axis_text_extents_without_no_visible_labels", () => {
        //given
    ...
    Test.add_func ("/Config#should_compute_max_displayed_value", () => {
        //given
